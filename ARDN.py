...
class ARDN_net():
    ...
    def build_graph(self):
        ...
        self.global_step = tf.Variable(0, trainable=False, name='learning_step')
        ...
        x = All_Residual_Group('RDG%02d' % self.n_ARDG, x, self.n_ARDB, self.n_ARDG, self.kernel_size, self.ratio, self.n_feats)
        x = Conv('conv_RG_tail', x, self.kernel_size, self.n_feats, self.n_feats, 1)
